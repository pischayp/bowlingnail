    ...
    <div class="container">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row" id="choose-date">
                                        ...
                                        ?>
                                            <div class="col-md-3">
                                                <img id="img-nailer" src="<?php echo $row1['nailer_picture'] ?>" class="img-fluid rounded-start" width="100%">
                                            </div>
                                            <div class="col-3">
                                                <p class="card-text">
                                                <p class="name">
                                                ...
                                                <div class="content-nailer">
                                                    <div class="dp">
                                                        <div class="py">
                                                            <input class="option-input radio" name="radionailer" type="radio" value="<?php echo $row1['nailer_id'] ?>" checked="checked" required />
                                                            &nbsp;&nbsp; เลือกช่างทำเล็บ
                                                            <br><br>
                                                        </div>
                                                    </div>
                                            ...
                                            ?>
                                                <div class="col-md-3">
                                                    <img id="img-nailer" src="<?php echo $row2['nailer_picture'] ?>" class="img-fluid rounded-start" width="100%">
                                                </div>
                                                <div class="col-3">
                                                    <p class="card-text">
                                                    <p class="name">
                                                    ...
                                                    <div class="content-nailer">
                                                        <div class="dp">
                                                            <div class="py">
                                                                ...
                                                                <input class="option-input radio" name="radionailer" id="show-nailer2" type="radio" value="<?php echo $row1['nailer_id'] ?>" required />
        ...
        <div class="row">
            ...
            <br>
                                                    ...
                                                    $sqlclock ="select * from book_nail_detail
                                                    order by book_id desc limit 1";
                                                    $result_clock = mysqli_query($conn, $sqlclock);
                                                    while ($query_clock= mysqli_fetch_assoc($result_clock)) {
                                                      
                                                    $nailer_id = $query_clock['nailer_id'];
                                                    }
                                                    $sql = "SELECT * from booking
                                                        INNER JOIN book_nail_detail ON book_nail_detail.book_id=booking.book_id
                                                        where booking.book_date = '$select_date' and  book_nail_detail.nailer_id=$nailer_id";
